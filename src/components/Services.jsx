...
import graphicDesingMovile from "../assets/mobile/image-graphic-design.jpg";
import graphicDesingDesktom from "../assets/desktop/image-graphic-design.jpg";
import photoMobile from "../assets/mobile/image-photography.jpg";
import photoDesktop from "../assets/Desktop/image-photography.jpg";
  ...
  return (
    <section className=" tablet:grid tablet:grid-cols-2">
      ...
      <ImageText
        ...
        imgMobile={graphicDesingMovile}
        imgDesktop={graphicDesingDesktom}
